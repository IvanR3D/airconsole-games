 ...
 * |-------|---------------|------------------|------------------|
 * | 1     | ≤200px        | ≤180px           | All reachable    |
 * | 2     | ≤200px        | ≤180px           | All reachable    |
 * | 3     | ≤200px        | ≤180px           | All reachable    |
 * | 4     | ≤200px        | ≤180px           | All reachable    |
 * | 5     | ≤200px        | ≤180px           | All reachable    |
 * 
 * Design Rules:
 * - Floor segment gaps must be ≤200px (max jump distance)
 * - Platform gaps must be ≤180px with vertical spacing 100-140px
...
const LEVELS = {
    1: {
        ...
        coins: [
            { x: 600, y: 340 }, { x: 1000, y: 280 }, { x: 1300, y: 320 },
            { x: 1800, y: 300 }, { x: 2200, y: 270 }, { x: 2800, y: 510 }
        ],
        obstacles: [
            { x: 750, y: 230, startX: 750 },
            { x: 1800, y: 220, startX: 1800 }
        ]
    },
    2: {
        ...
        coins: [
            { x: 490, y: 340 }, { x: 790, y: 280 }, { x: 1050, y: 320 },
            { x: 1390, y: 260 }, { x: 1690, y: 300 }, { x: 2040, y: 240 },
            { x: 2340, y: 280 }, { x: 2740, y: 320 }, { x: 3600, y: 510 }
        ],
        obstacles: [
            { x: 650, y: 210, startX: 650 },
            { x: 1350, y: 220, startX: 1350 },
            { x: 2150, y: 215, startX: 2150 },
            { x: 2950, y: 225, startX: 2950 }
        ]
    },
    3: {
        name: "Torre Alta",
        ...
        coins: [
            { x: 430, y: 340 }, { x: 680, y: 300 }, { x: 930, y: 260 },
            { x: 1180, y: 280 }, { x: 1480, y: 240 }, { x: 1780, y: 200 },
            { x: 2090, y: 320 }, { x: 2390, y: 270 }, { x: 2740, y: 230 },
            { x: 3040, y: 290 }, { x: 3390, y: 330 }, { x: 3730, y: 280 }
        ],
        obstacles: [
            { x: 550, y: 210, startX: 550 },
            { x: 1150, y: 220, startX: 1150 },
            { x: 1850, y: 215, startX: 1850 },
            { x: 2600, y: 225, startX: 2600 },
            { x: 3350, y: 230, startX: 3350 },
            { x: 4100, y: 220, startX: 4100 }
        ]
    },
    4: {
        ...
        coins: [
            { x: 375, y: 340 }, { x: 625, y: 300 }, { x: 870, y: 260 },
            { x: 1125, y: 280 }, { x: 1425, y: 320 }, { x: 1720, y: 280 },
            { x: 2025, y: 240 }, { x: 2325, y: 300 }, { x: 2675, y: 260 },
            { x: 2975, y: 300 }, { x: 3280, y: 250 }, { x: 3630, y: 310 },
            { x: 3930, y: 270 }, { x: 4230, y: 310 }, { x: 5000, y: 510 }
        ],
        obstacles: [
            { x: 480, y: 210, startX: 480 },
            { x: 1050, y: 220, startX: 1050 },
            { x: 1700, y: 215, startX: 1700 },
            { x: 2400, y: 225, startX: 2400 },
            { x: 3100, y: 230, startX: 3100 },
            { x: 3850, y: 220, startX: 3850 },
            { x: 4550, y: 225, startX: 4550 }
        ]
    },
    5: {
        ...
        coins: [
            { x: 315, y: 340 }, { x: 565, y: 300 }, { x: 820, y: 260 },
            { x: 1070, y: 300 }, { x: 1320, y: 240 }, { x: 1570, y: 200 },
            { x: 1840, y: 320 }, { x: 2135, y: 270 }, { x: 2385, y: 220 },
            { x: 2685, y: 170 }, { x: 2985, y: 300 }, { x: 3285, y: 250 },
            { x: 3585, y: 290 }, { x: 3885, y: 230 }, { x: 4185, y: 190 },
            { x: 4485, y: 320 }, { x: 4785, y: 270 }, { x: 5850, y: 510 }
        ],
        obstacles: [
            { x: 450, y: 210, startX: 450 },
            { x: 1000, y: 220, startX: 1000 },
            { x: 1600, y: 215, startX: 1600 },
            { x: 2250, y: 225, startX: 2250 },
            { x: 2900, y: 230, startX: 2900 },
            { x: 3500, y: 220, startX: 3500 },
            { x: 4200, y: 225, startX: 4200 },
            { x: 4950, y: 230, startX: 4950 },
            { x: 5600, y: 220, startX: 5600 }
        ]
    }
};
 ...
 * 
 * Checks:
 * - Floor segment gaps are ≤280px (max jump distance with safety margin)
 * - Platform horizontal gaps are ≤180px
...
function validateLevel(levelData) {
    ...
    if (!hasWarnings) {
        console.log(`[${levelName}] Level validation passed ✓`);
    }
...
class Game {
    constructor(playerNum, color, name) {
        ...
        // Helper method to calculate normalized scaling ratio based on player count
        this._getScalingRatio = (canvasHeight) => {
            const playerCount = Object.keys(GameManager.state.players).filter(
                n => !GameManager.state.players[n].disconnected
            ).length;
            
            // Base height reference adjusted for player count to maintain consistent scaling
            // Improved scaling for better responsiveness across devices (laptops to TVs)
            let baseHeight = 700;
            if (playerCount === 1) baseHeight = 1200; // Reduced from 1400 for better single player view
            else if (playerCount === 2) baseHeight = 1200; // Reduced from 1400 for better split screen
            else if (playerCount === 3) baseHeight = 950; // Reduced from 1050
            
            // Apply a smoother scaling curve for larger screens
            const ratio = canvasHeight / baseHeight;
            
            // Clamp ratio to prevent extreme scaling on very large or small screens
            return Math.max(0.6, Math.min(ratio, 1.8));
        };
    ...
    init() {
        ...
        // Normalize ratio based on player count to keep consistent scaling
        const ratio = this._getScalingRatio(this.canvas.height);
    ...
    _updatePhysics(p, prevY) {
        ...
        this.platforms.forEach(pl => {
            if (p.x + p.w > pl.x + 2 && p.x < pl.x + pl.width - 2) {
                if (p.vy >= 0 && prevY + p.h <= pl.y + 8 && p.y + p.h >= pl.y && p.y < pl.y + pl.h) {
                    ...
                    // Move player with platform if it's moving
                    if (pl.speed > 0) {
                        if (pl.prevX !== undefined) {
                            const platformDeltaX = pl.x - pl.prevX;
                            p.x += platformDeltaX;
                        } else {
                            // Initialize prevX if not set
                            pl.prevX = pl.x;
                        }
                    }
                }
        ...
        if (this.jumpBufferCounter > 0 && canJump) {
            ...
            this.coyoteCounter = 0;
            this.jumpBufferCounter = 0;
            // Aumentar cantidad de partículas de burst de 5 a 12
            this._burst(p.x + p.w/2, p.y + p.h, '#8BC34A', 12);
            // Agregar partícula tipo 'ring' con propiedades especificadas
    ...
    _updateCamera(p) {
        // Calcular offset de look-ahead: p.facing * 100 píxeles en dirección del movimiento
        ...
        // Calcular posición base de cámara
        let targetCamX = p.x - this.canvas.width / 2 + this.lookAheadOffset;
        
        // Agregar efecto de shake cuando p.stunned > 0 usando valores aleatorios de ±4 píxeles
        if (p.stunned > 0) {
            targetCamX += (Math.random() - 0.5) * 8;
        }
        
        // Mantener límites existentes (0 hasta finishX - canvas.width + 150)
    ...
    _updateCoins(p) {
        this.coinList.forEach(c => {
            ...
            if (distSq < 900) {
                ...
                // Agregar partícula tipo 'text' con propiedades especificadas
                const maxParticles = 150;
                if (this.particles.length < maxParticles) {
                    this.particles.push({
                        x: c.x,
    ...
    _checkFinish(p) {
        if (p.x > this.finishX && !this.won) {
            ...
            // Show overlay only on winner's screen
            if (finishedCount === 1 && this.won) {
    ...
    _drawOffScreenIndicators(ctx, w, h) {
        this.coinList.forEach(c => {
            ...
            // Verificar si moneda está fuera de pantalla comparando c.x con this.camX y this.camX + w
    ...
    _drawPlatforms(ctx, w) {
        this.platforms.forEach(pl => {
            ...
            // Agregar líneas verticales cada 20px con fillStyle = 'rgba(255, 255, 255, 0.1)'
            ctx.fillStyle = 'rgba(255, 255, 255, 0.1)';
            for (let x = pl.x; x < pl.x + pl.width; x += 20) {
                ctx.fillRect(x, pl.y, 1, pl.h);
            }
            
            // Para plataformas móviles (pl.speed > 0), dibujar indicador dorado en la parte superior centrada (20px de ancho, 2px de alto)
            if (pl.speed > 0) {
    ...
    _drawCoins(ctx, w) {
        ...
        this.coinList.forEach(c => {
            ...
            // Aumentar amplitud de bob de 4 a 6 píxeles
            ...
            // Aumentar radio de moneda de 14 a 18 píxeles
            ctx.fillStyle = '#EB8225';
            ctx.beginPath();
            ...
            // Cambiar fuente de símbolo a bold 16px para mejor visibilidad
            ctx.fillStyle = 'white';
            ...
            // Agregar partículas brillantes intermitentes cuando Math.sin(t / 100 + c.bob) > 0.8
    ...
    _drawParticles(ctx) {
        this.particles.forEach(pt => {
            ...
            if (pt.type === 'ring') {
                ...
                // Partículas circulares existentes
                ctx.fillStyle = pt.color;
                ctx.beginPath();
    ...
    resize(newWidth, newHeight) {
        ...
        // Normalize ratio based on player count to keep consistent scaling
        const oldRatio = this._getScalingRatio(oldHeight);
        const newRatio = this._getScalingRatio(newHeight);
        const scaleY = newRatio / oldRatio;
        
        // Only apply scaling if the change is significant (avoid micro-adjustments)
        if (Math.abs(scaleY - 1) > 0.05) {
            ...
            // Just update floor position for minor changes
            this.floorY = newHeight - 70;
            this.floors.forEach(f => f.y = this.floorY);
        }

        // Adjust camera to maintain player visibility
        const targetCamX = this.player.x - newWidth / 2 + this.lookAheadOffset;
        this.camX = Math.max(0, Math.min(targetCamX, this.finishX - newWidth + 150));
    }
    ...
    loop() {
        ...
        // Update live ranking every 10 frames only on winner's screen
        // But don't block game updates for other players
        if (GameManager.state.liveRankingVisible && 
            GameManager.state.liveRankingWinnerNum === this.num) {
...
const GameManager = {
    ...
    _setupEventListeners() {
        ...
        window.addEventListener('resize', () => {
            if (this.state.started) {
                ...
                // Throttle resize events to max once per 150ms for better performance
    ...
    _setupScreens(count) {
        ...
        for (let n in this.state.players) {
            ...
            div.innerHTML = `
                ...
                <!-- Live Ranking Overlay for this specific screen -->
                <div id="liveRankingOverlay${n}" class="hidden absolute inset-0 z-[60] overlay-backdrop">
                    <div class="ranking-panel">
                        <div class="mb-6">
                            <h2 class="winner-title text-3xl sm:text-4xl font-black mb-4 flex items-center justify-center gap-3">
                                🏆 ¡Primer Lugar!
                            </h2>
                            <div id="winnerInfo${n}" class="flex flex-col items-center gap-3">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="livePositionList${n}" class="space-y-2">
                        ...
                        <div class="continue-message text-center text-sm text-gray-600 mt-4">
                            ...
                            Los demás jugadores continúan compitiendo...
                        </div>
                    </div>
                </div>
            `;
    ...
    showLiveRankingOverlay(winnerNum) {
        ...
        // Only show overlay on winner's screen - check if winnerNum game exists and won
        const winnerGame = this.state.games[winnerNum];
        if (!winnerGame || !winnerGame.won) return;
        
        // Store winner number for filtering updates
        this.state.liveRankingWinnerNum = winnerNum;
        
        // Get the overlay specific to this winner's screen
        const overlay = DOM.get(`liveRankingOverlay${winnerNum}`);
        const winnerInfoEl = DOM.get(`winnerInfo${winnerNum}`);
        
        if (overlay && winnerInfoEl) {
    ...
    displayLiveRanking(players) {
        // Update ranking only on winner's screen overlay
        if (this.state.liveRankingWinnerNum) {
            const listEl = DOM.get(`livePositionList${this.state.liveRankingWinnerNum}`);
            if (!listEl) return;
            
            let html = '';
            players.forEach((player, index) => {
                const position = index + 1;
                const status = player.finished ? '✅ Terminó' : '🏃 Corriendo';
    ...
    hideLiveRankingOverlay() {
        ...
        for (let n in this.state.players) {
            const overlay = DOM.get(`liveRankingOverlay${n}`);
            if (overlay) {
                overlay.classList.add('hidden');
        ...
        this.state.liveRankingWinnerNum = null;
    },
